  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        <p className="fixed left-0 top-0 flex w-full justify-center bg-alert-green pb-6 pt-8 text-white backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:p-4">
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm text-light-gray">
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm text-dark">
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <h2 className="mb-3 text-2xl font-semibold text-alert-red">
            Templates{" "}
            <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">
              -&gt;
            </span>
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <h2 className="mb-3 text-2xl font-semibold text-alert-orange">
            Deploy{" "}
            <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">
              -&gt;
            </span>
